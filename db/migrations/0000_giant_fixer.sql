CREATE TABLE `user_token` (
	...
	`user_auth_tag` text NOT NULL,
	`device_ciphertext` text NOT NULL,
	`device_iv` text NOT NULL,
	`device_auth_tag` text NOT NULL,
...
CREATE UNIQUE INDEX `user_token_user_id_unique` ON `user_token` (`user_id`);--> statement-breakpoint
